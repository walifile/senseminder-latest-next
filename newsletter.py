...
FROM_EMAIL = os.environ.get("FROM_EMAIL", "no-reply@senseminder.com")
REPLY_TO_EMAIL = os.environ.get("REPLY_TO_EMAIL", "support@senseminder.com")
BRAND_NAME = os.environ.get("BRAND_NAME", "SenseMinder")
WEBSITE_URL = os.environ.get("WEBSITE_URL", "https://senseminder.com")
...
def _brand_text_html() -> str:
    ...
    name = BRAND_NAME or "SenseMinder"
    parts = name.split()
    if len(parts) >= 2:
        left = parts[0]
        right = " ".join(parts[1:])
