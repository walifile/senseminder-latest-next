...
const content = getUseCaseContent("creative");
...
export default function CreativeUseCasePage() {
  return (
    <>
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildUseCaseJsonLd("creative")),
        }}
      />
      <UseCasePage slug="creative" />
    </>
  );
}
