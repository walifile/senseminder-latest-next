...
const content = getUseCaseContent("remote-work");
...
export default function RemoteWorkUseCasePage() {
  return (
    <>
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildUseCaseJsonLd("remote-work")),
        }}
      />
      <UseCasePage slug="remote-work" />
    </>
  );
}
