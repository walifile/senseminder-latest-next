...
export const AccessibilityManager: React.FC<AccessibilityManagerProps> = ({
  ...
  const [testText, setTestText] = useState(
    "This is a test of the screen reader functionality. The quick brown fox jumps over the lazy dog."
  );
  ...
  useEffect(() => {
    ...
    root.style.setProperty(
      ...
      `${visualSettings.fontSize}px`
    );

    // Apply line spacing
    root.style.setProperty(
      "--accessibility-line-height",
      visualSettings.lineSpacing.toString()
    );

    // Apply cursor size
    root.style.setProperty(
      "--accessibility-cursor-size",
      `${visualSettings.cursorSize}em`
    );
      ...
      try {
        switch (key) {
          ...
          case "cursorHighlight":
            await connection.setCursorSettings(
              newSettings.cursorSize,
              newSettings.cursorHighlight
            );
            break;
          default:
    ...
    if (connection && isConnected) {
      try {
        switch (key) {
          ...
          case "speechPitch":
          case "speechVoice":
            await connection.setSpeechSettings(
              newSettings.speechRate,
              newSettings.speechPitch,
              newSettings.speechVoice
            );
            break;
    ...
    if (connection && isConnected) {
      try {
        switch (key) {
          ...
          case "dwellClick":
          case "dwellTime":
            await connection.setDwellClick(
              newSettings.dwellClick,
              newSettings.dwellTime
            );
            break;
          case "voiceControl":
            if (typeof value === "boolean") {
  ...
  const testTextToSpeech = () => {
    ...
    const selectedVoice = availableVoices.find(
      (voice) => voice.name === audioSettings.speechVoice
    );
    if (selectedVoice) {
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleVisualSettingChange("highContrast", checked)
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleVisualSettingChange("colorScheme", value)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={(value) =>
                    handleVisualSettingChange("fontSize", value[0])
                  }
                  min={10}
                  max={24}
                  step={1}
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {visualSettings.lineSpacing}x
                  </span>
                </div>
                <Slider
                  value={[visualSettings.lineSpacing]}
                  onValueChange={(value) =>
                    handleVisualSettingChange("lineSpacing", value[0])
                  }
                  min={1}
                  max={3}
                  step={0.1}
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleVisualSettingChange("magnifierEnabled", checked)
                    }
                  />
                </div>
                ...
                {visualSettings.magnifierEnabled && (
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm text-muted-foreground">
                        {visualSettings.magnificationLevel}%
                      </span>
                    </div>
                    <Slider
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {visualSettings.cursorSize}x
                    </span>
                  </div>
                  <Slider
                    value={[visualSettings.cursorSize]}
                    onValueChange={(value) =>
                      handleVisualSettingChange("cursorSize", value[0])
                    }
                    min={1}
                    max={4}
                    step={0.5}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleVisualSettingChange("cursorHighlight", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleVisualSettingChange("focusIndicator", checked)
                    }
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleVisualSettingChange("animationsReduced", checked)
                  }
                />
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleAudioSettingChange("screenReaderEnabled", checked)
                  }
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleAudioSettingChange("speechVoice", value)
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    onValueChange={(value) =>
                      handleAudioSettingChange("speechRate", value[0])
                    }
                    min={10}
                    max={100}
                    step={5}
                ...
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    onValueChange={(value) =>
                      handleAudioSettingChange("speechPitch", value[0])
                    }
                    min={10}
                    max={100}
                    step={5}
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleAudioSettingChange("soundNotifications", checked)
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Slider
                    ...
                    onValueChange={(value) =>
                      handleAudioSettingChange("soundVolume", value[0])
                    }
                    max={100}
                    step={5}
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleAudioSettingChange("keyboardSounds", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleAudioSettingChange("alertSounds", checked)
                    }
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleAudioSettingChange("captionsEnabled", checked)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleAudioSettingChange("audioDescriptions", checked)
                  }
                />
              </div>
            </CardContent>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("stickyKeys", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("slowKeys", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("bounceKeys", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("filterKeys", checked)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("mouseKeys", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("clickAssist", checked)
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleMotorSettingChange("dwellClick", checked)
                      }
                    />
                  </div>
                  ...
                  {motorSettings.dwellClick && (
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm text-muted-foreground">
                          {motorSettings.dwellTime}ms
                        </span>
                      </div>
                      <Slider
                        value={[motorSettings.dwellTime]}
                        onValueChange={(value) =>
                          handleMotorSettingChange("dwellTime", value[0])
                        }
                        min={500}
                        max={5000}
                        step={250}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("dragLock", checked)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("gestureRecognition", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("voiceControl", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleMotorSettingChange("eyeTracking", checked)
                    }
                  />
                </div>
              </div>
                ...
                <CardContent className="pt-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Test your motor skills with click accuracy and timing
                      exercises.
                    </p>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleCognitiveSettingChange("readingMode", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleCognitiveSettingChange("focusMode", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleCognitiveSettingChange("distractionFilter", checked)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleCognitiveSettingChange("guidedNavigation", checked)
                    }
                  />
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleCognitiveSettingChange("taskBreakdown", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleCognitiveSettingChange("reminders", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleCognitiveSettingChange("autoSave", checked)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {cognitiveSettings.sessionTimeout} min
                  </span>
                </div>
                <Slider
                  value={[cognitiveSettings.sessionTimeout]}
                  onValueChange={(value) =>
                    handleCognitiveSettingChange("sessionTimeout", value[0])
                  }
                  min={5}
                  max={120}
                  step={5}
              ...
              <Card className="bg-blue-50 dark:bg-blue-950">
                <CardContent className="pt-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Take a brief assessment to personalize cognitive
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-2 text-yellow-600 dark:text-yellow-400">
              ...
              <span className="text-sm">
                Connect to DCV session to enable full accessibility
                functionality and sync settings.
              </span>
            </div>
          </CardContent>
        </Card>
