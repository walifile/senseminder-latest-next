...
import { OtpVerificationDialog } from "@/app/auth/_components/otp-verification-dialog";
...
const BUSINESS_LOGIN_REDIRECT = `${routes.auth}?from=${routes.businessOnboarding.replace(/^\//, "")}`;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        sessionStorage.setItem("businessOrganizationName", organizationName);
        sessionStorage.setItem("businessSignupIntent", "true");

        toast({
          title: "Success",
          description: (
            <span data-testid="business-signup-success-message">
              Business account created successfully! Please verify your email.
            </span>
          ),
        });
  ...
  return (
    <>
                ...
                <div className="w-full max-w-[430px] space-y-4">
                  <div className="space-y-3">
                    ...
                    <p className="max-w-lg text-sm leading-6 text-slate-500 dark:text-slate-300 md:text-[15px]">
                      Create your owner account, add your organization name,
                      and get ready to launch your first pilot PCs.
                    </p>
                  </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3.5">
                      <div className="relative">
                        <Building2 className="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-[#8EA2FF]" />
                        <Input
                      ...
                      <p className="text-[11px] leading-4 text-slate-500 dark:text-slate-300">
                        # Use your business e-mail address.
                      </p>
                      ...
                      <div className="space-y-2">
                        <div className="relative">
                          ...
                          <Input
                            ...
                            required
                            uiSize="lg"
                            className="h-8 pl-10 pr-10 text-sm"
                          />
                      ...
                      <div className="flex gap-3 pt-1">
                        <Button
                          ...
                          size="lg"
                          className={cn(
                            "h-8 w-full rounded-full text-sm font-medium",
                    ...
                    <p className="mt-4 text-center text-xs text-slate-400 dark:text-slate-300">
      ...
      <OtpVerificationDialog
        ...
        otpInputTestId="business-signup-otp-input"
        submitButtonTestId="business-signup-verify-otp-button"
        onVerified={() => {
          setIsOtpOpen(false);
          router.push(BUSINESS_LOGIN_REDIRECT);
        }}
      />
    </>
  );
