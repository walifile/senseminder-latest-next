      ...
      <div className="flex-grow pt-20 md:pt-28 pb-16">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12 md:items-start">
          <div className="w-full min-w-0 md:col-span-4 self-start md:sticky md:top-24">
            <PrivacySidebar sections={sections} lastUpdated={lastUpdated} />
          </div>
          ...
          <div className="w-full min-w-0 md:col-span-8">
            <div className="glass-card !shadow-none gradient-outline-border !rounded-3xl !border-0 space-y-6 overflow-x-hidden">
              ...
              <div className="w-full max-w-[820px] mx-auto break-words">
                {/* How we handle your data */}
                                  <section id="how-we-handle-your-data" className="scroll-mt-28">
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        ...
                        including Sense PC (virtual desktop computing) and Sense
                        Cloud (cloud-based file storage).
                      </p>
                      <p className={legalPara}>
                        Senseminder LLC is a U.S.-based company registered in
                        the State of Georgia. All data handling practices comply
                        with applicable federal and state privacy laws including
                        GDPR, CCPA/CPRA, Virginia CDPA, Colorado CPA,
                        Connecticut CTDPA, and other applicable regulations.
                      </p>
                      <p className={legalPara}>
                        By using our Services, you agree to this Privacy Policy.
                        If you do not agree, please refrain from using our
                        Services.
                      </p>
                    </div>
                  </section>
                ...
                {/* Personal Information We Collect */}
                                  <section id="personal-information" className="scroll-mt-28">
                    <div className="space-y-4 p-8">
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        We collect various categories of personal information to
                ...
                {/* How We Use Your Information */}
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        ...
                        and reliable Sense PC and Sense Cloud services.
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        ...
                        <li>
                          <span className="font-medium">Note:</span> You can opt
                          out anytime via email or account settings
                        </li>
                      </ul>
                ...
                {/* How We Share Your Information */}
                                  <section id="how-we-share-your-information" className="scroll-mt-28">
                    <div className="space-y-4 p-8">
                      <h2 className="font-space-grotesk font-semibold text-2xl md:text-3xl text-black dark:text-white">
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        ...
                        data as necessary to deliver services, comply with law,
                        or protect our platform.
                      </p>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        ...
                        <li>
                          All providers are contractually bound to protect your
                          data
                        </li>
                      </ul>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        ...
                        <li>
                          To protect rights, safety, or property of Senseminder
                          and users
                        </li>
                      </ul>
                      ...
                      <p className={legalPara}>
                        In mergers, acquisitions, or asset sales, user
                        information may be transferred. We will notify you and
                        ensure the receiving party maintains equivalent privacy
                        protections.
                      </p>
                      ...
                      <p className={legalPara}>
                        We may share data for purposes you explicitly authorize
                        (e.g., third-party app integrations).
                      </p>
                    </div>
                  </section>

                {/* Third-Party Service Providers and Subprocessors */}
                                  <section id="third-party-service-providers-and-subprocessors" className="scroll-mt-28">
                    <div className="space-y-4 p-8">
                      <h2 className="font-space-grotesk font-semibold text-2xl md:text-3xl">
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        We share personal information only with trusted
                        providers contractually bound to protect your data.
                      </p>
                        ...
                        <table className="w-full border-collapse text-left text-sm">
                          ...
                          <tbody>
                            ...
                            <tr className="border-t border-black/10 dark:border-white/10">
                              ...
                              <td className={`px-4 py-3 ${legalPara}`}>USA</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>We notify customers of subprocessor changes:</li>
                        <li>Via email to registered address</li>
                        <li>Posted at: https://sensepc.com/subprocessors</li>
                        <li>
                          At least 30 days advance notice for new subprocessors
                        </li>
                      </ul>
                      <p className={legalPara}>
                        Enterprise customers may object to new subprocessors on
                        reasonable data protection grounds by contacting
                        contact@sensepc.com within 30 days.
                      </p>
                    </div>
                  </section>
                ...
                {/* Data Retention */}
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        ...
                        to fulfill purposes in this Policy, unless longer
                      ...
                      <div className="mt-4 overflow-x-auto rounded-xl border border-black/10 dark:border-white/10">
                        <table className="w-full border-collapse text-left text-sm">
                          ...
                          <tbody className={legalPara}>
                            ...
                            <tr className="border-t border-black/10 dark:border-white/10">
                              <td className="px-4 py-3 text-black dark:text-white">
                                Sense PC Instance Data
                              </td>
                              <td className="px-4 py-3">
                                Until instance deletion by user
                              </td>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          After retention periods, we permanently delete data
                          using secure methods preventing recovery.
                        </li>
                      </ul>
                      ...
                      <ul className={`pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          We may retain data beyond the stated periods when
                          required for:
                          <ul
                            className={`list-disc pl-6 mt-2 space-y-2 ${legalPara}`}
                          >
                            <li>
                              Legal obligations (litigation holds, government
                              investigations)
                            </li>
                ...
                {/* Data Breach Notification */}
                                  <section id="data-breach-notification" className="scroll-mt-28">
                    <div className="space-y-4 p-8">
                      <h2 className="font-space-grotesk font-semibold text-2xl md:text-3xl text-black dark:text-white">
                      ...
                      <ul className="pl-0 space-y-4 text-paragraph mt-3">
                        ...
                        <li>
                          ...
                          >
                            ...
                            <li>
                              Describe the nature of the breach, data affected,
                              and potential consequences
                            </li>
                            <li>
                              Explain measures taken and recommended user
                              actions
                            </li>
                            <li>
                        ...
                        <li>
                          ...
                          >
                            ...
                            <li>
                              For USA users: Notify per applicable state breach
                              notification laws (Cal. Civ. Code § 1798.82 and
                              similar statutes in all 50 states) and federal
                              requirements.
                            </li>
                            <li>
                              For EU users: Notify within 72 hours per GDPR Art.
                              33.
                            </li>
                          </ul>
                        </li>
                      ...
                      <p className={`mt-2 ${legalPara}`}>
                        A “data breach” means unauthorized access, disclosure,
                        or acquisition of personal information that compromises
                      ...
                      <ul
                        className={`list-disc pl-6 space-y-2 ${legalPara} mt-3`}
                      >
                        <li>Unsuccessful access attempts (blocked attacks)</li>
                        <li>
                          Encrypted data incidents where keys are not
                          compromised
                        </li>
                        <li>
                ...
                {/* Your Rights & Choices */}
                                  <section id="your-rights-choices" className="scroll-mt-28">
                    <div className="space-y-4 p-8">
                      <h2 className="font-space-grotesk font-semibold text-2xl md:text-3xl text-black dark:text-white">
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        Depending on your location and applicable law (GDPR, USA
                        state privacy laws), you may have the following rights:
                      </p>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          Request to pause or restrict data use, or object to
                          specific processing
                        </li>
                      </ul>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          Receive your data in structured, machine-readable
                          format or have it transmitted to another provider
                        </li>
                      </ul>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        ...
                        <li>
                          Provide: Your name, email, account ID, and specify
                          which right you wish to exercise
                        </li>
                        <li>
                          Response time: Within 30 days (may extend to 45 days
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          ...
                          Email from registered address OR login via dashboard
                          OR use MFA
                        </li>
                        <li>
                          <span className="font-medium text-black dark:text-white">
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          ...
                          Account profile, user content, Sense Cloud files,
                        ...
                        <li>
                          ...
                          &lt;1GB within 48 hours; larger datasets within 10
                          business days
                        </li>
                      </ul>
                    </div>
                ...
                {/* USA Privacy Rights (State Privacy Laws) */}
                                  <section id="usa-privacy-rights-state-privacy-laws" className="scroll-mt-28">
                    <div className="space-y-4 p-8">
                      <h2 className="font-space-grotesk font-semibold text-2xl md:text-3xl text-black dark:text-white">
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        This section applies to USA residents under applicable
                        state privacy laws including California CCPA/CPRA,
                        Virginia Consumer Data Protection Act (CDPA), Colorado
                        Privacy Act (CPA), Connecticut Data Privacy Act (CTDPA),
                        Utah Consumer Privacy Act (UCPA), and other state
                        privacy statutes.
                      </p>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        ...
                        <li>
                          Subject Line:{" "}
                          <span className="font-medium text-black dark:text-white">
                            "USA Privacy Rights Request"
                          </span>
                        </li>
                        <li>
                          Include: Full name, email address, account ID (if
                      ...
                      <p className={`mt-2 ${legalPara}`}>
                        ...
                        and other state privacy laws. We have not sold personal
                      ...
                      <ul className="pl-0 space-y-2 text-paragraph">
                        <li>
                          <span className="text-black dark:text-white">
                            If submitting a request through an authorized agent,
                          ...
                          >
                            ...
                            <li>
                              Verification that they are registered with
                              appropriate state authority (if required)
                            </li>
                          </ul>
                        </li>
                      </ul>
                    ...
                    <div className="space-y-4 p-8">
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          ...
                          HTTPS (TLS) for data in transit; AWS KMS for sensitive
                          data at rest
                        </li>
                        <li>
                          <span className="font-medium text-black dark:text-white">
                        ...
                        <li>
                          ...
                          AWS security best practices, network isolation, and
                          firewalls
                        </li>
                        <li>
                          <span className="font-medium text-black dark:text-white">
                      ...
                      <p className={`mt-2 ${legalPara}`}>
                        While we take reasonable security steps, no system is
                        completely immune to breaches. We do not accept
                        liability for unauthorized access beyond our reasonable
                        control, particularly if caused by user negligence or
                        third-party misuse.
                      </p>
                    </div>
                  </section>
                ...
                {/* Cookies & Tracking Technologies */}
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        Senseminder does not use cookies or similar tracking
                        technologies for behavioral advertising or analytics. We
                        are committed to a privacy-focused experience.
                      </p>

                      <p className={legalPara}>
                        While we may use limited local device storage (e.g.,
                        session memory for UI preferences), no persistent
                      ...
                      <p className={legalPara}>
                        ...
                        (e.g., analytics), we will update this policy and
                        provide opt-in consent options.
                      </p>
                    </div>
                  </section>
                ...
                {/* Children's Privacy */}
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        Senseminder does not knowingly collect information from
                        individuals under 16. Our services are intended for
                        users 16 years or older.
                      </p>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          If you are under 16, do not register for an account,
                          use our services, or submit personal information.
                        </li>
                      </ul>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          During registration, users must certify they are 16+.
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          If we discover collection from a child under 16
                          without consent:
                          <ul
                            className={`list-disc pl-6 mt-2 space-y-2 ${legalPara}`}
                          >
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          ...
                          >
                            ...
                            <li>
                              Refuse further collection or use of their
                              child&apos;s information
                            </li>
                          </ul>
                        </li>
                      ...
                      <p className={legalPara}>
                        Senseminder LLC, Attn: Privacy - Children&apos;s
                        Inquiries, Atlanta, Georgia, USA
                      </p>

                      <p className={legalPara}>
                        Provide: Proof of parental relationship, child&apos;s
                        account info, government ID for verification
                      </p>
                    </div>
                  </section>
                ...
                {/* International Transfers */}
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        Senseminder LLC is headquartered in the USA and uses
                        cloud infrastructure (AWS) that may process or store
                        data in various global locations.
                      </p>
                      ...
                      <p className={`mt-2 ${legalPara}`}>
                        To provide high availability, we may store and process
                        data in the USA or other countries where our
                        infrastructure operates, which may involve cross-border
                        transfers.
                      </p>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          For international transfers, particularly from EEA/UK,
                          we implement:
                          <ul
                            className={`list-disc pl-6 mt-2 space-y-2 ${legalPara}`}
                          >
                      ...
                      <p className={`mt-2 ${legalPara}`}>
                        Senseminder LLC complies with the EU-US Data Privacy
                        Framework (DPF), UK Extension to EU-US DPF, and Swiss-US
                        DPF as set forth by the U.S. Department of Commerce.
                      </p>
                      ...
                      <p className={`mt-2 ${legalPara}`}>
                        ...
                        processing and transfer of your data outside your
                ...
                {/* Notice to European Users (GDPR/UK) */}
                                  <section id="notice-european-users" className="scroll-mt-28">
                    <div className="space-y-4 p-8">
                      <h2 className="font-space-grotesk font-semibold text-2xl md:text-3xl text-black dark:text-white">
                    ...
                    <div className="space-y-4 p-8">
                      <p className={legalPara}>
                        If you are in the European Economic Area (EEA) or United
                        Kingdom (UK), the following outlines your data rights
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          ...
                          – to provide services and fulfill agreements
                        </li>
                        <li>
                          <span className="font-medium">
                            Legitimate interests
                          </span>{" "}
                          – to improve services, ensure security, prevent fraud
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          – to comply with laws and legal requests
                        </li>
                      </ul>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          <span className="font-medium">Access</span> – Obtain
                          confirmation and a copy of your data
                        </li>
                        <li>
                        ...
                        <li>
                          <span className="font-medium">Erasure</span> – Request
                          deletion (right to be forgotten)
                        </li>
                        <li>
                          <span className="font-medium">Restriction</span> – Ask
                          us to restrict processing in specific scenarios
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          Object to processing based on legitimate interest or
                ...
                {/* Changes to This Privacy Policy */}
                                  <section id="privacy-policy-changes" className="scroll-mt-28">
                    <div className="space-y-4 p-8">
                      <h2 className="font-space-grotesk font-semibold text-2xl md:text-3xl text-black dark:text-white">
                    ...
                    <div className="space-y-4 p-8">
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          ...
                          >
                            ...
                            <li>
                              Notify you via email or a platform notice for
                              material changes
                            </li>
                            <li>
                              Provide at least 30 days’ notice before material
                              changes take effect
                            </li>
                          </ul>
                        </li>
                      ...
                      <p className={legalPara}>
                        Your continued use after changes become effective
                        constitutes acceptance of the updated Privacy Policy. If
                        you disagree, you may close your account.
                      </p>

                      <p className={legalPara}>
                        We encourage periodic review of this Privacy Policy to
                        stay informed about data protection.
                      </p>
                    </div>
                  </section>
                    ...
                    <div className="space-y-4 p-8">
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        ...
                        <li>
                          ...
                          Senseminder LLC, Attn: Privacy Officer, 1372
                          Peachtree, Atlanta, GA 30309, USA
                        </li>
                      </ul>
                      ...
                      <ul className={`list-disc pl-6 space-y-2 ${legalPara}`}>
                        <li>
                          ...
                          Exercise your state privacy law rights using the
                          contact information above with{" "}
                          <span className="font-medium">
                            “USA Privacy Rights Request”
                          </span>{" "}
                          in the subject line.
                        ...
                        <li>
                          ...
                          Contact your local Data Protection Authority if you
                          have concerns about our data handling practices.
                        </li>
                      </ul>
                    </div>
                  </section>
