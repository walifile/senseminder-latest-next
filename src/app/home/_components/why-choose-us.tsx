    ...
    <div className="container mx-auto px-4 md:px-6">
      <div className="text-center mb-16 max-w-3xl mx-auto">
        ...
        >
          ...
          pay-as-you-go model, instant scaling, and robust cloud security, it's
            ...
            {comparisons.map((item, index) => (
              ...
              >
                ...
                <div className="space-y-1 text-right">
                  <div className="font-medium text-primary">{item.smartpc}</div>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      >
        <h3 className="text-2xl md:text-3xl font-bold mb-8">
          Experience the <span className="gradient-text">Freedom</span> of Cloud
          Computing Today!
        </h3>
        <Button
          asChild
