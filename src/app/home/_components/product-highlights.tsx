...
const ProductHighlights = () => (
  <div className="container relative my-12 md:my-20">
    <div className="max-md:flex max-md:flex-col md:grid md:grid-cols-2 md:grid-rows-3 gap-6 md:gap-8">
      ...
      <div className="relative rounded-2xl p-4 max-md:order-2 md:p-12 space-y-6 md:space-y-12 overflow-hidden bg-[#F5FAFE] dark:bg-transparent dark:bg-[linear-gradient(276.71deg,_rgba(128,134,243,0.5)_-194.99%,_rgba(3,10,135,0.25)_-40.44%,_rgba(186,37,240,0.5)_248.78%)]">
      ...
      <div className="relative rounded-2xl p-4 max-md:order-4 md:p-12 md:row-span-2 space-y-6 md:space-y-10 overflow-hidden bg-[#F5FAFE] dark:bg-transparent dark:bg-[radial-gradient(70.39%_50.81%_at_35.28%_-15.16%,_rgba(215,94,255,0.25)_0%,_rgba(9,2,51,0.5)_100%)]">
        <div className="space-y-6 md:space-y-9">
          <div className="space-y-2">
            <p className="font-space-grotesk font-bold text-2xl md:text-3xl">
      ...
      <div className="relative rounded-2xl p-4 max-md:order-3 md:p-12 space-y-6 md:space-y-12 overflow-hidden bg-[#F5FAFE] dark:bg-transparent dark:bg-[linear-gradient(276.71deg,_rgba(128,134,243,0.5)_-194.99%,_rgba(3,10,135,0.25)_-40.44%,_rgba(186,37,240,0.5)_248.78%)]">
        <div className="flex max-md:flex-col gap-4">
          <Image
