...
//       <div className="absolute inset-0 rounded-full blur-xl dark:bg-primary/20 bg-primary/10" />
...
const Hero = () => (
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
    ...
    <div className="absolute inset-0 w-full h-full bg-background">
      ...
      <div className="absolute top-0 -right-4 w-72 h-72 bg-yellow-500 rounded-full mix-blend-multiply filter blur-xl opacity-10 dark:opacity-20 animate-blob animation-delay-2000" />
    ...
    <div className="absolute inset-0">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#8882_1px,transparent_1px),linear-gradient(to_bottom,#8882_1px,transparent_1px)] dark:bg-[size:14px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000,transparent)]" />
        ...
        <div className="text-center space-y-8">
          ...
          >
            <h1 className="text-3xl md:text-5xl lg:text-5xl font-bold leading-tight">
              The <span className="gradient-text">Future</span> of Computing is
              Here
            </h1>
            <div className="absolute -top-6 -right-6 w-12 h-12 bg-primary/10 rounded-full blur-lg" />
            <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-primary/10 rounded-full blur-lg" />
          </motion.div>
          ...
          >
            <div className="absolute inset-0 blur-2xl bg-primary/10 dark:bg-primary/20 -z-10" />
          </motion.h2>
