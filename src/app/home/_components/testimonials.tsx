...
import { Star, User, Quote, Building } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 rounded-xl border border-primary/20 dark:border-white/10" />

            {/* Hover effect */}
            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl" />
          </div>
        ))}
      </div>
