            ...
            <div className="container relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 px-8">
                ...
                <div className="w-full lg:w-1/2 space-y-8">
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            whileTap={{scale: 0.95}}
                            className="inline-flex w-full md:w-auto text-center md:text-left items-center justify-center gap-1.5 whitespace-nowrap font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 outline-border text-sm h-10 rounded-full px-4 text-white"
                            style={{
                ...
                <div className="lg:w-1/2 relative hidden lg:flex">
                    ...
                    <div className="relative flex-shrink-0 w-16 mr-6">
                        ...
                        <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 font-semibold px-6 py-2 rounded-full shadow-lg whitespace-nowrap text-black dark:text-white border-2 border-transparent"
                             style={{
                                 top: 'calc(50% - 16px)',
                                 fontSize: '20px',
                                 backgroundImage: 'linear-gradient(white, white), linear-gradient(to left, #A801BA 0%, #2530F0 100%)',
                                 backgroundOrigin: 'border-box',
                                 backgroundClip: 'padding-box, border-box'
                             }}>
                            <div className="absolute inset-0 rounded-full hidden dark:block border-2 border-transparent"
                                 style={{
                    ...
                    <div className="flex-1 space-y-8 ms-2">
                        {steps.map((step, index) => (
                            <motion.div
                                ...
                                className="relative"
                            >
                                <Card className="relative border p-10 border-white/10 rounded-2xl hover:opacity-90 transition-all duration-300 group bg-[#F4F1FF] dark:bg-transparent">
                                    <div className="absolute inset-0 rounded-2xl hidden dark:block"
                                         style={{
                                             background: 'linear-gradient(to right, #310E68 0%, #0C0A40 33%'
                                         }} />
                ...
                <div className="w-full lg:hidden relative flex flex-col items-center">
                    {steps.map((step, index) => (
                        <div key={index} className="relative w-full flex flex-col items-center">
                            ...
                            {index > 0 && (
                                <>
                                    <div className="w-0.5 opacity-60"
                                         style={{
                                             height: '32px',
                                             background: 'repeating-linear-gradient(to botmake tom, #8b5cf6 0px, #8b5cf6 8px, transparent 8px, transparent 16px)'
                                         }} />

                                    {/* Step badge */}
                                    <div className="flex justify-center relative z-10">
                                        <div className="font-semibold px-6 py-2 rounded-full shadow-lg whitespace-nowrap text-black dark:text-white relative border-2 border-transparent"
                                             style={{
                                                 fontSize: '20px',
                                                 backgroundImage: 'linear-gradient(white, white), linear-gradient(to left, #A801BA 0%, #2530F0 100%)',
                                                 backgroundOrigin: 'border-box',
                            ...
                            >
                                <Card className="relative border border-white/10 rounded-2xl p-6 hover:opacity-90 transition-all duration-300 bg-[#F4F1FF] dark:bg-transparent">
                                    <div className="absolute inset-0 rounded-2xl hidden dark:block"
                                         style={{
