...
import { getPromoInfo, redeemPromo } from "@/api/promocashback";
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        console.error("Failed to load promo info:", e.message);
      } finally {
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center gap-1">
              ...
              <QuickStatsTooltip content="This is your available wallet balance. It is used for all
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center gap-1">
              ...
              <QuickStatsTooltip content="This shows your total charges for Sense PC and Sense Storage
        ...
        <CardContent>
          <div className="space-y-1">
            <div className="text-2xl font-bold tracking-tight">
              {spendingLoading ? <QuickStatsLoading /> : fCurrency(currentMonthSpending)}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
              ...
              <div className="flex justify-between text-sm text-muted-foreground font-medium">
                {[{
                    label: "Promotion",
                    tooltip: "Promotional balance is a limited-time credit added to your account (e.g., from offers or referrals). It can only be used for service usage and holds no real-world cash value.",
                    value: promoInfo?.promoBalance || 0,
                    color: "text-sky-500",
                  }, ...promotionsAndCashback.filter(item => item.label !== "Promotion")].map((item, idx, arr) => (
                    <React.Fragment key={item.label}>
                      ...
                      {idx < arr.length - 1 && <div className="w-px bg-border mx-3" />}
                    </React.Fragment>
                  ))}
              </div>
            )}
      ...
      <>
        <DialogHeader className="flex flex-col items-center space-y-2">
          ...
          <DialogDescription className="text-center">
            Are you sure you want to claim your free SmartPC credits? <br />
          ...
          <Button
            ...
            onClick={async () => {
              ...
              try {
                ...
                toast.error(e.message || "Failed to redeem promo");
              } finally {
                setRedeeming(false);
              }
            }}
