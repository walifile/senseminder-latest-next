            ...
            <div className="space-y-2">
              ...
              >
                <div>
                  ...
                  >
                    <div className="rounded-md border border-border mb-3 w-full h-20 bg-background" />
                    Dark
                  </Label>
                </div>
                ...
                <div>
                  ...
                  <Label
                    ...
                    className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-card p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary"
                  >
                    <div className="rounded-md border border-border mb-3 w-full h-20 bg-white" />
                    Light
                  </Label>
                </div>
                ...
                <div>
                  ...
                  <Label
                    ...
                    className="flex flex-col items-center justify-between rounded-md border-2 border-muted bg-card p-4 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary [&:has([data-state=checked])]:border-primary"
                  >
                    <div className="rounded-md border border-border mb-3 w-full h-20 bg-gradient-to-r from-background to-white" />
                    System
                  </Label>
                </div>
              </RadioGroup>
            ...
            <div className="space-y-2">
              ...
              <RadioGroup defaultValue="email" className="space-y-1">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="login-none">No Additional Verification</Label>
                </div>
              </RadioGroup>
            </div>
