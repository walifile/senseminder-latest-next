            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    transit ensures your information remains private and secure.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Complete isolation between different users' data and strict
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Get verification codes via email for additional security
                        layer.
                      </p>
                      <Button variant="outline" size="sm" className="mt-2">
                        Setup Email MFA
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    You retain full ownership of your data. We never access your
                    personal files without explicit permission.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Clear policies about what data we collect and how it's used,
                    with options to export or delete your data.
                  </p>
                </div>
              </div>
            </div>
