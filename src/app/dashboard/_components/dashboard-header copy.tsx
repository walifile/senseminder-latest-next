...
//   const HEADER_ICON_BTN = "size-10"; // matches ProfileDropdown Button size-10
//   const HEADER_ICON_IMG = 20;
//   // useEffect(() => {
...
//                   "bg-[#2530f0] text-white shadow-[0_10px_24px_-12px_rgba(37,48,240,0.65)]"
//                 )}
...
//                   <div
//                     className="pointer-events-none absolute inset-[2px] rounded-full border border-white/40 dark:border-transparent"
//                     aria-hidden
//                   />
//                   <div
//                     className="pointer-events-none absolute inset-[6px] rounded-full bg-white/25 dark:bg-transparent"
//                     aria-hidden
//                   />
//                   <Button
...
//                     className={cn(
//                       HEADER_ICON_BTN,
//                       "relative rounded-full bg-gradient-to-b dark:bg-white/5 dark:from-white/5 dark:to-white/5 from-[#e9ecff] to-[#dfe5ff]",
