...
export const PLAN_COPY: Record<BillingPlan, PlanCopy> = {
  hourly: {
    label: "Hourly",
    unit: "/hour",
    tagline: "Unlimited usage — pay per hour while running.",
    included: ["Pay only for actual usage", "No minimum commitment", "Support included"],
  },
  daily: {
    label: "Daily",
    unit: "/day",
    tagline: "Ideal for a full workday session without hourly tracking.",
  ...
  monthly: {
    label: "Monthly",
    unit: "/month",
    tagline: "Best for consistent monthly usage and predictable budgeting.",
    estimateNote: "Estimated based on your current configuration.",
